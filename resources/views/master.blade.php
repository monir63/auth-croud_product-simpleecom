        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="shopping-cart"></i><span class="menu-title text-truncate" data-i18n="eCommerce">Product</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href={{route('allproduct')}}><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Shop">All Product</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href={{route('products')}}><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Details">Add Product</span></a>
                        </li>
                    </ul>
                </li>
